use doge_light_client::{
    common_types::QHash256, hash::sha256_impl::hash_impl_sha256_hash_three_buffers_concat,
};

use crate::{
    claim::auto_claim_deposits_tree::{
        constants::AUTO_CLAIM_DEPOSITS_TREE_HEIGHT,
        pending_mints_buffer_builder::PendingMintsGroupsBuilder,
    },
    utils::append_only_merkle_tree::AppendOnlyMerkleTreeFixed,
};
...
impl AutoClaimDepositsTreeAppendBuilder {
    ...
    pub fn append_leaf(&mut self, tx_hash: &QHash256, public_key: &QHash256, amount: u64) {
        ...
        let leaf_hash =
            hash_impl_sha256_hash_three_buffers_concat(tx_hash, public_key, &amount.to_le_bytes());
